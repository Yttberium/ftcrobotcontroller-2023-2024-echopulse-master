...
public class AutonomousRedTrussPoses {
    ...
    public static Pose2d getStack2Pose(AutonomousUtils.AllianceColor color, AutonomousUtils.StartPosition startPosition)
    {
        if(startPosition== AutonomousUtils.StartPosition.Corner)
            ...
            return mirrorColor(new Pose2d(-2*AutonomousUtils.TILE_WIDTH-AutonomousUtils.TILE_WIDTH_HALF+4, -AutonomousUtils.TILE_WIDTH_HALF-5, Math.toRadians(30)), color);
    }
