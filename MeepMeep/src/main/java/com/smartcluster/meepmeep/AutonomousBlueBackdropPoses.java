...
public class AutonomousBlueBackdropPoses {
    ...
    public static Pose2d getCasePose(AutonomousUtils.AllianceColor color, AutonomousUtils.StartPosition startPosition, AutonomousUtils.AutoCase autoCase)
    {
        ...
        final Pose2d trussCase = new Pose2d(0.5, -(AutonomousUtils.TILE_WIDTH+AutonomousUtils.TILE_WIDTH_HALF)+1, Math.toRadians(150)).plus(robotFromPurplePixel);
        final Pose2d middleCase = new Pose2d(AutonomousUtils.TILE_WIDTH_QUARTER+2,-AutonomousUtils.TILE_WIDTH-0.5, Math.toRadians(110)).plus(robotFromPurplePixel);
    ...
    {
        return mirrorColor(new Pose2d(-3*AutonomousUtils.TILE_WIDTH, -AutonomousUtils.TILE_WIDTH-AutonomousUtils.TILE_WIDTH_HALF+4, Math.toRadians(0)), color).plus(new Twist2d(new Vector2d(15+6.5,0),mirrorColor(Math.toRadians(-15),color)));
    }
    public static Pose2d getStack2Pose(AutonomousUtils.AllianceColor color, AutonomousUtils.StartPosition startPosition)
    {
        return mirrorColor(new Pose2d(-3*AutonomousUtils.TILE_WIDTH, -AutonomousUtils.TILE_WIDTH-AutonomousUtils.TILE_WIDTH_HALF+2, Math.toRadians(0)), color).plus(new Twist2d(new Vector2d(15+6.5,0),mirrorColor(Math.toRadians(-15),color)));
    }
    ...
    {
        final Pose2d baseBackdropPose = new Pose2d(2*AutonomousUtils.TILE_WIDTH+3.5,-AutonomousUtils.TILE_WIDTH-AutonomousUtils.TILE_WIDTH_HALF,Math.toRadians(0));
        final double[] offset = new double[] {-6,0.75,4.5};
    ...
    public static Pose2d getBackdropExterior(AutonomousUtils.AllianceColor color, AutonomousUtils.StartPosition startPosition)
    {
        ...
        if(startPosition== AutonomousUtils.StartPosition.Basket)
            return mirrorColor(new Pose2d(2*AutonomousUtils.TILE_WIDTH+3.5,-AutonomousUtils.TILE_WIDTH-AutonomousUtils.TILE_WIDTH_HALF+5,Math.toRadians(0)),color);
        else return mirrorColor(new Pose2d(2*AutonomousUtils.TILE_WIDTH+3.5,-AutonomousUtils.TILE_WIDTH-AutonomousUtils.TILE_WIDTH_HALF-4,Math.toRadians(0)),color);
